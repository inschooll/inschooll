...
function getColor(variant: "blue" | "green" | "red" | "gray") {
  switch (variant) {
    ...
    case "green":
      return "bg-cc-green/50 border-cc-green/70 hover:bg-cc-green/60 hover:border-cc-green active:bg-cc-green/80";
    case "red":
      return "bg-cc-red/50 border-cc-red/70 hover:bg-cc-red/60 hover:border-cc-red active:bg-cc-red/80";
    case "gray":
